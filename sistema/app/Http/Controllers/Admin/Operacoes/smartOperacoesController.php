...
use App\Models\Admin\Smart\Operacoes;
use App\Http\Controllers\Admin\Header\notificacoesController;


class smartOperacoesController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.operacoes.smart.listagem')->with($dados);       
    ...
    public function edit($id)
    {
        ...
        return view("admin.operacoes.smart.editar")->with($dados);
    }
